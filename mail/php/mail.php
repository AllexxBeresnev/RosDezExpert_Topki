...
// ini_set('display_startup_errors', 1);
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		require_once($_SERVER['DOCUMENT_ROOT'] . '/topki/mail/phpmailer/phpmailer.php');
		require_once($_SERVER['DOCUMENT_ROOT'] . '/topki/mail/php/config.php');
		require_once($_SERVER['DOCUMENT_ROOT'] . '/topki/mail/php/valid.php');
